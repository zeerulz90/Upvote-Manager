import '../styles/AddUpvote.css'

import { useUpvoteAdd } from '../context/UpvoteListsContext';

export default function AddUpvote({ list }) {
    const addUpvote = useUpvoteAdd();
    return (
        <div className="upvoteAdd" onClick={() => addUpvote(list.id)} data-testid={"add-upvote-btn-" + list.id}>
